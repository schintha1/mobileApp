 ...
 */
public class Alert_nis_not_available extends Fragment {


    public Alert_nis_not_available() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_alert_nis_not_available, container, false);
