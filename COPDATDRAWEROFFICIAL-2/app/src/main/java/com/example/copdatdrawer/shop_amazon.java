...
public class shop_amazon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_shopamazon, container, false);
    ...
    public class DB extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            LinearLayout x  = v.findViewById(R.id.itemListA);
                ...
                for (int i = 0; i<CheckBoxes.size(); i++){
                    if (CheckBoxes.get(i).isChecked()){
                        ...
                        if (num <=count ){
                            ...
                            String queryString2= "INSERT INTO cart Values (DEFAULT,"+1+","+id+","+nisnum+")";
                            st.executeUpdate(queryString);
