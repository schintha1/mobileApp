...
public class shop_walmart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("Walmart");
        v = inflater.inflate(R.layout.fragment_shopwalmart, container, false);
    ...
    public class DB extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            checkItem.clear();
            LinearLayout x  = v.findViewById(R.id.itemListW);
